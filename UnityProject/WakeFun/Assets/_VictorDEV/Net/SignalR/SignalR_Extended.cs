...
namespace VictorDev.Net.SignalrUtils
{
    ...
    /// <summary>
    /// 擴增此套件的SignalR
    /// <para>https://github.com/evanlindsey/Unity-WebGL-SignalR/tree/main?tab=readme-ov-file</para>
    /// <para>+ 新增連接失敗Event</para>
    /// </summary>
    public class SignalR_Extended
    {
        private static SignalR_Extended instance;
        public SignalR_Extended()
        {
            instance = this;
        }
        ...
        {
            var args = new ConnectionEventData
            {
                ConnectionId = connectionId
            };
            instance.ConnectionStarted?.Invoke(instance, args);
        }
        public event EventHandler<ConnectionEventData> ConnectionStarted;
        ...
        public event EventHandler<ConnectionEventData> ConnectionClosed;
        ...
        public async void Connect()
        {
            ...
            catch (Exception ex)
            {
                ...
                ConnectionFailed?.Invoke($"ConnectionFailed: {ex.Message}");
            }
        }
